...
import { DEFAULT_CONFIG, WAVE_SCRAWLER_SHADER } from "./conf";
import { useLoadedImages } from "./hooks";
import type { ITransitionRenderer, IWaveScrawler } from "./types";
...
>(WaveScrawler);
export type { ImageSource, ITransitionRenderer, IWaveScrawler } from "./types";
